...
<div class="content">
	<div class="tableContent2">
		<div class="titTable2">
			<h2><?php echo (isset($this->_rootref['TITLE'])) ? $this->_rootref['TITLE'] : ''; ?></h2>
		</div>
		<div class="table2">
        	<a name="goto"></a>
<?php if ($this->_rootref['PAGE'] == 0) {  ?>
	...
	<?php if ($this->_rootref['ERROR'] != ('')) {  ?>
					<tr>
						...
						<td class="errfont"><span class="text-error"><?php echo (isset($this->_rootref['ERROR'])) ? $this->_rootref['ERROR'] : ''; ?></span></td>
					</tr>
	<?php } ?>
					<tr>
	...
	<?php if ($this->_rootref['B_SUBTITLE']) {  ?>
					<tr>
						<td align="right" width="25%" valign="top" class="leftpan">
							<b>Ship from<!--<?php echo ((isset($this->_rootref['L_806'])) ? $this->_rootref['L_806'] : ((isset($MSG['806'])) ? $MSG['806'] : '{ L_806 }')); ?>--></b>
						</td>
						<td class="rightpan">
					...
					<tr>
						<td align="right" width="25%" valign="top" class="leftpan">
							<b><!--<?php echo ((isset($this->_rootref['L_25_0215'])) ? $this->_rootref['L_25_0215'] : ((isset($MSG['25_0215'])) ? $MSG['25_0215'] : '{ L_25_0215 }')); ?>-->Ship to</b>
						</td>
						<td>
							<input name="shipping_terms" type="text" size="40" maxlength="70" value="<?php echo (isset($this->_rootref['SHIPPING_TERMS'])) ? $this->_rootref['SHIPPING_TERMS'] : ''; ?>">
						</td>
					</tr>
	<?php } ?>
					<tr>
						<td align="right" width="25%" valign="top" class="leftpan">
							<b>Item size (cubic metres)<!--<?php echo ((isset($this->_rootref['L_018'])) ? $this->_rootref['L_018'] : ((isset($MSG['018'])) ? $MSG['018'] : '{ L_018 }')); ?>--></b>
						</td>
						<td class="rightpan">
	...
	<?php } ?>
					...
					<tr>
						<td align="right" width="25%" valign="top" class="leftpan">
							<b id="minval_text"><!--<?php echo (isset($this->_rootref['MINTEXT'])) ? $this->_rootref['MINTEXT'] : ''; ?>-->Max Shipping Cost <br/>(Start of bidding)</b>
						</td>
						<td class="rightpan">
					...
					<tr>
						<td align="right" width="25%" valign="top" class="leftpan">
							<b><!--<?php echo ((isset($this->_rootref['L_023'])) ? $this->_rootref['L_023'] : ((isset($MSG['023'])) ? $MSG['023'] : '{ L_023 }')); ?>-->Approximate value of goods</b>
						</td>
						<td class="rightpan">
    ...
    <?php } ?>
					...
					<tr>
						...
						<td valign="top" class="rightpan"><!--
							...
							<label class="checkbbox"><?php echo ((isset($this->_rootref['L_031'])) ? $this->_rootref['L_031'] : ((isset($MSG['031'])) ? $MSG['031'] : '{ L_031 }')); ?></label><br>
							<input type="radio" name="shipping" id="sps" value="2" <?php echo (isset($this->_rootref['SHIPPING2'])) ? $this->_rootref['SHIPPING2'] : ''; ?>>
							<?php echo ((isset($this->_rootref['L_032'])) ? $this->_rootref['L_032'] : ((isset($MSG['032'])) ? $MSG['032'] : '{ L_032 }')); ?></label><br>
							<input type="checkbox" name="international" value="1" <?php echo (isset($this->_rootref['INTERNATIONAL'])) ? $this->_rootref['INTERNATIONAL'] : ''; ?>>
							<label class="checkbbox"><?php echo ((isset($this->_rootref['L_033'])) ? $this->_rootref['L_033'] : ((isset($MSG['033'])) ? $MSG['033'] : '{ L_033 }')); ?></label>-->
							<input type="hidden" name="international" value="1"/>
							<input type="hidden" name="shipping" value="sps"/>
					...
					<tr>
						...
						<td>
							<input type="text" maxlength="70" size="40" name="shipping_terms" value="<?php echo (isset($this->_rootref['SHIPPING_TERMS'])) ? $this->_rootref['SHIPPING_TERMS'] : ''; ?>">
						</td>
					</tr>
					<tr>
						<td align="right" width="25%" valign="top" class="leftpan">
	...
	<?php if ($this->_rootref['B_MKFEATURED'] || $this->_rootref['B_MKBOLD'] || $this->_rootref['B_MKHIGHLIGHT']) {  ?>
        ...
        <?php if ($this->_rootref['B_MKFEATURED']) {  ?>
        					<p><label class="checkbox"><input type="checkbox" name="is_featured" id="is_featured" <?php echo (isset($this->_rootref['IS_FEATURED'])) ? $this->_rootref['IS_FEATURED'] : ''; ?>>&nbsp;<?php echo ((isset($this->_rootref['L_273'])) ? $this->_rootref['L_273'] : ((isset($MSG['273'])) ? $MSG['273'] : '{ L_273 }')); ?></label></p>
        <?php } if ($this->_rootref['B_MKBOLD']) {  ?>
        					<p><label class="checkbox"><input type="checkbox" name="is_bold" id="is_bold" <?php echo (isset($this->_rootref['IS_BOLD'])) ? $this->_rootref['IS_BOLD'] : ''; ?>>&nbsp;<?php echo ((isset($this->_rootref['L_274'])) ? $this->_rootref['L_274'] : ((isset($MSG['274'])) ? $MSG['274'] : '{ L_274 }')); ?></label></p>
        <?php } if ($this->_rootref['B_MKHIGHLIGHT']) {  ?>
        					<p><label class="checkbox"><input type="checkbox" name="is_highlighted" id="is_highlighted" <?php echo (isset($this->_rootref['IS_HIGHLIGHTED'])) ? $this->_rootref['IS_HIGHLIGHTED'] : ''; ?>>&nbsp;<?php echo ((isset($this->_rootref['L_292'])) ? $this->_rootref['L_292'] : ((isset($MSG['292'])) ? $MSG['292'] : '{ L_292 }')); ?></label></p>
        <?php } ?>
						</td>
					</tr>
	<?php } if ($this->_rootref['B_AUTORELIST']) {  ?>
	...
	<?php } ?>
				...
				<div style="text-align:center">
					...
					<input type="submit" name="" value="<?php echo ((isset($this->_rootref['L_5189'])) ? $this->_rootref['L_5189'] : ((isset($MSG['5189'])) ? $MSG['5189'] : '{ L_5189 }')); ?>"  class="btn btn-large btn-success"><!--&nbsp;&nbsp;&nbsp;<input type="reset" name="" value="<?php echo ((isset($this->_rootref['L_5190'])) ? $this->_rootref['L_5190'] : ((isset($MSG['5190'])) ? $MSG['5190'] : '{ L_5190 }')); ?>" class="button">-->
				</div>
			</form>
<?php } else if ($this->_rootref['PAGE'] == (1)) {  ?>
	...
	<?php if ($this->_rootref['B_SUBTITLE']) {  ?>
			<tr>
				<td width="40%" align="right"  valign="top"><b>Ship from, ship to<!--<?php echo ((isset($this->_rootref['L_806'])) ? $this->_rootref['L_806'] : ((isset($MSG['806'])) ? $MSG['806'] : '{ L_806 }')); ?>--></b></td>
				<td width="60%" ><?php echo (isset($this->_rootref['SUBTITLE'])) ? $this->_rootref['SUBTITLE'] : ''; ?></td>
			</tr>
	<?php } ?>
			<tr>
				<td  valign="top" align="right"><b>Item size (cubic metres)<!--<?php echo ((isset($this->_rootref['L_018'])) ? $this->_rootref['L_018'] : ((isset($MSG['018'])) ? $MSG['018'] : '{ L_018 }')); ?>--></b></td>
	...
	<?php } ?>
			...
			<tr>
				<td align="right" valign="top"><b>Ship to<!--<?php echo ((isset($this->_rootref['L_25_0215'])) ? $this->_rootref['L_25_0215'] : ((isset($MSG['25_0215'])) ? $MSG['25_0215'] : '{ L_25_0215 }')); ?>--></b></td>
