...
<!--                <span style="background-color:{cat_list.COLOUR}">-->
                <a href="browse.php?id={cat_list.ID}">{cat_list.IMAGE}{cat_list.NAME} {cat_list.CATAUCNUM}</a> 
                <!--</span>-->
            </li>
<!-- END cat_list -->
        </ul><br/><br/>
...
<td valign="top">
    ...
    <tr>
        ...
        <!-- BEGIN featured -->
            <div style="float:left;display:block;width:180px;margin:5px;background-color:#FFFEEE;border:#CCCCCC 1px solid;padding:5px;">
                ...
                <div style="display:block;" align="center">Ship 1 <a href="{SITEURL}item.php?id={featured.ID}">{featured.TITLE}</a> from USA to AUSTRALIA for less than <br>{featured.BID}</div>
            </div>
        <!-- END featured -->
        </td>
    </tr>  
    <tr>
        <td class="titTable4">
            <h2>
                <p>Need an item shipped to you?</p>
                <p><a href="sell.php?" class="btn btn-large btn-success">List an item - it's free!</a></p>
            </h2>
        </td>
    </tr>
    <!-- IF B_HOT_ITEMS -->
    <tr>
        ...
        <td class="titTable4"><h2>Can you ship it cheaper?</h2></td>
    </tr>
    <tr>
        <td class="table2">
        <!-- BEGIN hotitems -->
            <div style="float:left;display:block;width:180px;margin:5px;background-color:#FFFEEE;border:#CCCCCC 1px solid;padding:5px;">
                ...
                <div style="display:block;" align="center">Ship 1 <a href="{SITEURL}item.php?id={hotitems.ID}">{hotitems.TITLE}</a> from USA to AUSTRALIA for less than <br>{hotitems.BID}</div>
            </div>
        <!-- END hotitems -->
        </td>
    </tr>
