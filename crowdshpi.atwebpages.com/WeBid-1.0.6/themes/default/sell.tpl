...
<!-- IF PAGE eq 0 -->
	...
	<!-- IF ERROR ne '' -->
					<tr>
						...
						<td class="errfont"><span class="text-error">{ERROR}</span></td>
					</tr>
	<!-- ENDIF -->
					<tr>
	...
	<!-- IF B_SUBTITLE -->
					...
					<tr>
						<td align="right" width="25%" valign="top" class="leftpan">
							<b><!--{L_25_0215}-->Ship to</b>
						</td>
						<td>
							<input name="shipping_terms" type="text" size="40" maxlength="70" value="{SHIPPING_TERMS}">
						</td>
					</tr>
	<!-- ENDIF -->
					<tr>
						<td align="right" width="25%" valign="top" class="leftpan">
							<b>Item size (cubic metres)<!--{L_018}--></b>
						</td>
						<td class="rightpan">
					   		{AUC_DESCRIPTION}
						</td>
	...
	<!-- ENDIF -->
					...
					<tr>
						<td align="right" width="25%" valign="top" class="leftpan">
							<b id="minval_text"><!--{MINTEXT}-->Max Shipping Cost <br/>(Start of bidding)</b>
						</td>
						<td class="rightpan">
					...
					<tr>
						<td align="right" width="25%" valign="top" class="leftpan">
							<b><!--{L_023}-->Approximate value of goods</b>
						</td>
						<td class="rightpan">
    ...
    <!-- ENDIF -->
					...
					<tr>
						...
						<td>
							<input type="text" maxlength="70" size="40" name="shipping_terms" value="{SHIPPING_TERMS}">
						</td>
					</tr>
					<tr>
						<td align="right" width="25%" valign="top" class="leftpan">
	...
	<!-- IF B_MKFEATURED or B_MKBOLD or B_MKHIGHLIGHT -->
                    <tr>
						...
						<td class="rightpan">
        <!-- IF B_MKFEATURED -->
        					<p><label class="checkbox"><input type="checkbox" name="is_featured" id="is_featured" {IS_FEATURED}>&nbsp;{L_273}</label></p>
        <!-- ENDIF -->
        <!-- IF B_MKBOLD -->
        					<p><label class="checkbox"><input type="checkbox" name="is_bold" id="is_bold" {IS_BOLD}>&nbsp;{L_274}</label></p>
        <!-- ENDIF -->
        <!-- IF B_MKHIGHLIGHT -->
        					<p><label class="checkbox"><input type="checkbox" name="is_highlighted" id="is_highlighted" {IS_HIGHLIGHTED}>&nbsp;{L_292}</label></p>
        <!-- ENDIF -->
						</td>
					</tr>
	<!-- ENDIF -->
	...
	<!-- ENDIF -->
				...
				<div style="text-align:center">
					...
					<input type="submit" name="" value="{L_5189}"  class="btn btn-large btn-success"><!--&nbsp;&nbsp;&nbsp;<input type="reset" name="" value="{L_5190}" class="button">-->
				</div>
			</form>
<!-- ELSEIF PAGE eq 1 -->
	...
	<!-- IF B_SUBTITLE -->
			<tr>
				<td width="40%" align="right"  valign="top"><b>Ship from, ship to<!--{L_806}--></b></td>
				<td width="60%" >{SUBTITLE}</td>
			</tr>
	<!-- ENDIF -->
			<tr>
				<td  valign="top" align="right"><b>Item size (cubic metres)<!--{L_018}--></b></td>
	...
	<!-- ENDIF -->
			...
			<tr>
				<td align="right" valign="top"><b>Ship to<!--{L_25_0215}--></b></td>
