...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Boxer: A Bootstrap Micro Theme</title>
  ...
  <body id="top">
    <div class="navbar navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container">
          ...
          <a class="brand" href="#top">CrowdShip</a>
        ...
        <div class="white_gradient">
          <div class="row">
            <div class="span12 align_center">
              <h1 class="boxer_title">Shipping on the Crowd</h1>
              <p>We can help each other to move goods around the world more efficiently</p>
              <a class="btn btn-large btn-success">I want something shipped</a>
              <a class="btn btn-large btn-info">I can help shipping</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <article class="body_article">
      <div class="container">
        <div class="row">
          <div class="span7"><img src="img/macbook.png" /></div>
          <div class="span5">
    ...
    <article class="body_article">
      <div class="container">
        <div class="row">
          ...
          <div class="span5 offset2"><img src="img/ipad.png"></div>
        </div>
      </div>
    </article>
    ...
    <article class="body_article">
      <div class="container">
        <div class="row">
          <div class="span6"><img src="img/ipads.png"></div>
